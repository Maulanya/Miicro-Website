...
export default function Boxes() {
  return (
    <section className='md:hidden gap-8 flex h-[800px] pt-12 bg-gradient-to-b from-[#191B20] via-[#191B20] to-transparent flex-col items-center relative z-10 mb-[350px] -top-[160px]'>
