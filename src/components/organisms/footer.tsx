    ...
    <footer className="text-white bg-dot-white/[0.2] px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className="gap-6 justify-between md:flex">
        ...
        >
          ...
          <div className="max-w-sm flex bg-[#1F2126] rounded-3xl p-3 mt-5">
            <input
              type="email"
              placeholder="Enter your email"
              className="w-full p-2.5 outline-0 bg-transparent"
            />
            <button
              className="p-2.5 relative w-[200px] font-ChillaxMedium rounded-full text-black bg-[#F4A4EC] outline-none shadow-md focus:shadow-none sm:px-5"
            >
              Sign up
            </button>
          </div>
